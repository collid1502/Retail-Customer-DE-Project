...
TS_start = datetime.date(year=year, month=month, day=startDay)
TS_end = datetime.date(year=year, month=month, day=endDay)
...
# create seed
seedVal = int(str(year) + str(month) + str(startDay))
...
# write data out
outPath = f"dataSources/transactions/{seedVal}_txns.csv"
